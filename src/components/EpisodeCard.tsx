...
export default function EpisodeCard({ episode, seriesSlug }: EpisodeCardProps) {
  return (
    <Link href={`/series/${seriesSlug}/episodes/${episode.slug}`} className="group">
      ...
      <div className="mt-2">
        ...
        <p className="text-white/60 text-sm">الحلقة {episode.episode_number}</p>
      </div>
    </Link>
  );
}
